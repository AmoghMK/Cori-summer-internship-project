    ...
    for sheet in wb.sheets():
        if (sheet.name==state):
            ...
            for row in range(1,nrows):
                ...
                evaplist.append(sheet.cell(row,4).value)
                cloudlist.append(sheet.cell(row,5).value)
    yieldpredict2=predict3([hightemppredict,lowtemppredict],yieldlist,hightemplist,lowtemplist)
    yieldpredict3=predict2(cloudpredict[0],yieldlist,cloudlist)
    yieldpredict4=predict3([preppredict,evappredict],yieldlist,preplist,evaplist)
